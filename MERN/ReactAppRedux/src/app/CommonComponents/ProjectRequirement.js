// Assessment of May Month - Below questions + demo of the same -
...
// Create productReviewReducer use it in store.js and also write switch case to add products
// Create a form to allow patient to submit Product Details - name, price, desc, rating
