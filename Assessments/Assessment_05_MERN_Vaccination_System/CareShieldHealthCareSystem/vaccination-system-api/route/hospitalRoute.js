...
const HospitalModel = require('../dataModel/hospitalDataModel'); // Import the Mongoose Hospital models
...
// REMOVED: PATCH /api/hospitals/:id/approve route, as the is_approved field is removed.
