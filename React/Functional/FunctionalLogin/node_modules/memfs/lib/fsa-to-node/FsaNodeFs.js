...
const optHelpers = require("memfs/lib/node/options");
const util = require("memfs/lib/node/util");
const buffer_1 = require("memfs/lib/internal/buffer");
const FsPromises_1 = require("memfs/lib/node/FsPromises");
const util_1 = require("memfs/lib/fsa-to-node/util");
const constants_1 = require("memfs/lib/node/constants");
const encoding_1 = require("memfs/lib/encoding");
const FsaNodeDirent_1 = require("memfs/lib/fsa-to-node/FsaNodeDirent");
const constants_2 = require("memfs/lib/constants");
const FsaNodeStats_1 = require("memfs/lib/fsa-to-node/FsaNodeStats");
const queueMicrotask_1 = require("memfs/lib/queueMicrotask");
const FsaNodeWriteStream_1 = require("memfs/lib/fsa-to-node/FsaNodeWriteStream");
const FsaNodeReadStream_1 = require("memfs/lib/fsa-to-node/FsaNodeReadStream");
const FsaNodeCore_1 = require("memfs/lib/fsa-to-node/FsaNodeCore");
const FileHandle_1 = require("memfs/lib/node/FileHandle");
const notSupported = () => {
