        ...
        return(
            <>
                ...
                <form className="form-control col-md-12" action={"/api/saveUser"} method="post"
                    ...
                    <b>User Password</b>
                    <input type="password" className="form-control" placeholder={"Default Student Password"}
                           ref={this.userPasswordRef} maxLength={15} required></input>

                    <b>User Mobile</b>
                    <input type="tel" className="form-control" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}"
                           placeholder={"123-456-7890"}
                           ref={this.userMobileRef} maxLength={12} required></input>
