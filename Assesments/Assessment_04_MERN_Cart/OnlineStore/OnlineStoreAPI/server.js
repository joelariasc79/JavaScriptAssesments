...
// Import the new Notification model and Notification Service
const Notification = require('./DataModel/Notification'); // Corrected path based on your folder structure
...
// --- New API Endpoints for Notifications (for Frontend to fetch) ---
...
// const orderRoute = require('./route/orderRoute');
// const couponRoute = require('./route/couponRoute');
// const setupScheduledTasks = require('./utils/cronJobs');
//
// //calling the cors instance
// const cors = require("cors");
//
