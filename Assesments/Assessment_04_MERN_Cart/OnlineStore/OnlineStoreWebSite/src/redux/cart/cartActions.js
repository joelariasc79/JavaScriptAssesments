...
//         try {
//             // Backend's /cart/add endpoint needs userId, productId, quantity in body
...
//             // Trigger cart fetch after add to ensure up-to-date cart count (for notifications)
...
//         try {
//             // Backend's /cart/:userId/items/:productId endpoint
...
//             // Trigger cart fetch after remove to ensure up-to-date cart count (for notifications)
//             dispatch(fetchCartItems(userId));
//         } catch (error) {
//             const errorMessage = error.response?.data?.message || error.message;
...
//             dispatch(fetchCartItems(userId)); // Re-fetch cart for updated count
//         } catch (error) {
//             const errorMessage = error.response?.data?.message || error.message;
...
//             dispatch(fetchCartItems(userId)); // Fetch cart to ensure it's empty after checkout
//         } catch (error) {
//             const errorMessage = error.response?.data?.message || error.message;
...
//             dispatch(fetchCartItems(userId)); // Re-fetch to ensure cart state is consistent (e.g., now empty)
//         } catch (error) {
//             const errorMessage = error.response?.data?.message || error.message;
...
// };
//
// export const processPayment = (orderId, paymentData, userId) => { // Added userId parameter
//     return async (dispatch) => {
//         dispatch(processPaymentRequest());
//         try {
//             // Backend now requires userId in the body for payment route
//             const dataToSend = { ...paymentData, userId: userId };
